// Generated by Wrangler by running `wrangler types /tmp/cf-image-proxy-bindings.d.ts --env-interface CloudflareBindings --include-runtime=false` (hash: 3184233ebac0af7b09f81fc03a3a1fb1)
declare namespace Cloudflare {
	interface Env {
		PIXIV_MODERATION_ENABLED: "false";
